...
/**
 * Key used to group and order {@link PropertySource}s into layers (@see Layers).
 * Layers are ordered by natural order such that a lower order values have 
 * precedence over a higher values.  Within a layer configurations are prioritized by
